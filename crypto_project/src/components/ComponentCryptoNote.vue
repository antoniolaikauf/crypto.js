...
<template>
  <section>
    ...
    <p>
      ...
      sono soggetti ad attacchi CCA (Chosen Ciphertext Attack) e CPA (Chosen Plaintext Attack). Tutte queste modalità sono a nonce-based encryption
      (il nonce deve cambiare ogni volta che si invia un messaggio) e, se ci sono dati invalidi, fermeranno la connessione e si capirà perché l'output
      sarà una ⊥. <br />
      ...
      IPsec che consiste prima nell'encrypt then MAC e all'interno del MAC ci sarà il testo cifrato, questo perché così il tag farà riferimento al
      testo cifrato e, se il testo cifrato verrà modificato, si potrà accorgere immediatamente. Per quanto riguarda i <b>modelli</b>, il
